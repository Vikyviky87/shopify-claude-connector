...
// Dashboard
// DASHBOARD CORRETTA - Sostituisci la route /dashboard con questo codice
...
app.get('/dashboard', async (req, res) => {
  try {
    ...
    // CALCOLI STATISTICHE AVANZATE (con controlli sicurezza)
    const now = new Date();
    ...
    const lowStock = products.filter(p => 
      p.variants && p.variants.some(v => (v.inventory_quantity || 0) > 0 && (v.inventory_quantity || 0) <= 5)
    ).length;
    ...
    const averageCustomerValue = customers.length > 0 ? 
      customers.reduce((sum, c) => sum + parseFloat(c.total_spent || 0), 0) / customers.length : 0;
        ...
        <div class="container">
          <div class="main-stats">
            <div class="stat-card">
              ...
              <div class="stat-change">+€${revenueThisMonth.toFixed(2)} questo mese</div>
            </div>
            ...
            <div class="stat-card">
              ...
              <div class="stat-change">+${ordersThisMonth.length} questo mese</div>
            </div>
            ...
            <div class="stat-card">
              ...
              <div class="stat-change">Base clienti attiva</div>
            </div>
            ...
            <div class="stat-card">
              ...
              <div class="stat-change">Performance stabile</div>
            </div>
            ...
            <div class="stat-card">
              ...
              <div class="stat-change">LTV in crescita</div>
            </div>
          </div>
              ...
              <div class="top-items">
                ${topProducts.map((product, index) => `
                  <div class="top-item">
                    ...
                    <div class="item-info">
                      <div class="item-name">${product.title || 'Prodotto'}</div>
              ...
              <div class="top-items">
                ${topCustomers.slice(0, 4).map((customer, index) => `
                  <div class="top-item">
                    ...
                    <div class="item-info">
                      <div class="item-name">${customer.first_name || 'Cliente'} ${customer.last_name || ''}</div>
                      <div class="item-details">${customer.orders_count || 0} ordini</div>
                    </div>
                    <div class="item-value">€${customer.total_spent || 0}</div>
                  </div>
                `).join('')}
              </div>
            </div>
